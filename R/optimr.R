...
#' @description
#' Execute a Bayesian (MAP) model fit using \code{\link[rstan:optimizing]{optimizing}}.
#' 
#' @param object compiled \code{bdm} class object
...
#' @seealso [compiler()], \code{\link[rstan:optimizing]{optimizing}}
#' @examples
#' # get some data
#' data(albio)
